...
class SpotifyAPI:
    ...
    TOKEN_URL = "https://accounts.spotify.com/api/BQBGiGMsS3cg48uUyDkdUPh-wsIeCAdzQpVGu1zV0PfaneojyPb1wtfxDFD2o4qu0R6uJsdqCnVWztQrLQW-VCeuXkVuG5me20ZuF-ewb0jF9WowhwQ"
    USER_ENDPOINT = "users"
    ...
    def _get_request(self, url, headers, params=None):
        ...
        response = requests.get('http://localhost:8888/callback', headers=headers, params=params)
